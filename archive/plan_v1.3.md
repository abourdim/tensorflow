...
|-------|---------|----------|--------|
| Tier 1 | v1.3 | Achievement system, Multiplayer mode, Build-your-own classifier, AI mistakes gallery, Dark/Light theme | 🔜 Current |
| Tier 2 | v1.4 | Certificates, Parent dashboard, AI Journal, Time capsule, QR posters | ⏳ Next |
...
- Estimated: ~800-900 lines (expanded from 500-600)
...
- Estimated: ~1100-1300 lines (expanded from 800-1000)
...
- Estimated: ~1600-1900 lines (expanded from 1200-1500)
...
| v1.3 | 2026-03-08 | **Tier 1 features:** Achievement system (badges across workshops), Multiplayer mode (all workshops), Build-your-own classifier (bonus missions), AI Mistakes Gallery (all workshops), Dark/Light theme toggle. Added Feature Roadmap. Estimated line counts updated. |
